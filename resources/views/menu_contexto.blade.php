<div id="statusContextMenu" class="fixed hidden z-50 w-48 bg-black border border-gray-700 rounded-md shadow-lg py-1 text-sm text-gray-300">
    <ul>
        ...
        <li onclick="setTipo('gasto')" class="px-3 py-1 hover:bg-gray-700 hover:text-white cursor-pointer transition-colors flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-3">
                <path stroke-linecap="round" stroke-linejoin="round" d="M18 12H6" />
            </svg>
            Gasto
        </li>
        <li onclick="setTipo('renda')" class="px-3 py-1 hover:bg-gray-700 hover:text-white cursor-pointer transition-colors flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-3">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m6-6H6" />
            </svg>
            Renda
        </li>
        <li onclick="setTipo('terceiros')" class="px-3 py-1 hover:bg-gray-700 hover:text-white cursor-pointer transition-colors flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-3">
