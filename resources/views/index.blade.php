    ...
    <nav class="bg-gray-800 border-b border-gray-700 p-2">
        <div class="w-full flex justify-between items-center px-4">
            <div class="flex items-center gap-3">
                ...
                <p class="text-2xl font-bold text-green-400">R$ 15.847,32</p>
            </div>
            
            <div class="flex gap-2">
                <!-- Cartão 1 -->
                <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg p-2 text-white w-32">
                    <div class="flex justify-between items-start mb-1">
                        <div class="w-6 h-4 bg-yellow-400 rounded text-xs"></div>
                        <span class="text-xs font-medium">VISA</span>
                    </div>
                    <p class="text-xs opacity-90">R$ 5.000</p>
                    <p class="text-xs font-bold">R$ 3.200</p>
                    <p class="text-xs opacity-75">15/01</p>
                </div>

                <!-- Cartão 2 -->
                <div class="bg-gradient-to-r from-red-600 to-red-800 rounded-lg p-2 text-white w-32">
                    <div class="flex justify-between items-start mb-1">
                        <div class="w-6 h-4 bg-yellow-400 rounded"></div>
                        <span class="text-xs font-medium">MASTER</span>
                    </div>
                    <p class="text-xs opacity-90">R$ 8.000</p>
                    <p class="text-xs font-bold">R$ 6.500</p>
                    <p class="text-xs opacity-75">20/01</p>
                </div>

                <!-- Cartão 3 -->
                <div class="bg-gradient-to-r from-purple-600 to-purple-800 rounded-lg p-2 text-white w-32">
                    <div class="flex justify-between items-start mb-1">
                        <div class="w-6 h-4 bg-gray-300 rounded"></div>
                        <span class="text-xs font-medium">ELO</span>
                    </div>
                    <p class="text-xs opacity-90">R$ 3.000</p>
                    <p class="text-xs font-bold">R$ 2.100</p>
                    <p class="text-xs opacity-75">10/01</p>
                </div>

                <!-- Cartão 4 -->
                <div class="bg-gradient-to-r from-green-600 to-green-800 rounded-lg p-2 text-white w-32">
                    <div class="flex justify-between items-start mb-1">
                        <div class="w-6 h-4 bg-yellow-400 rounded"></div>
                        <span class="text-xs font-medium">AMEX</span>
                    </div>
                    <p class="text-xs opacity-90">R$ 10.000</p>
                    <p class="text-xs font-bold">R$ 8.500</p>
                    <p class="text-xs opacity-75">25/01</p>
                </div>

                <!-- Cartão 5 -->
                <div class="bg-gradient-to-r from-orange-600 to-orange-800 rounded-lg p-2 text-white w-32">
                    <div class="flex justify-between items-start mb-1">
                        <div class="w-6 h-4 bg-gray-300 rounded"></div>
                        <span class="text-xs font-medium">HIPER</span>
                    </div>
                    <p class="text-xs opacity-90">R$ 2.000</p>
                    <p class="text-xs font-bold">R$ 1.800</p>
                    <p class="text-xs opacity-75">12/01</p>
                </div>

                <!-- Cartão 6 -->
                <div class="bg-gradient-to-r from-pink-600 to-pink-800 rounded-lg p-2 text-white w-32">
                    <div class="flex justify-between items-start mb-1">
                        <div class="w-6 h-4 bg-yellow-400 rounded"></div>
                        <span class="text-xs font-medium">NUBANK</span>
                    </div>
                    <p class="text-xs opacity-90">R$ 6.000</p>
                    <p class="text-xs font-bold">R$ 4.200</p>
                    <p class="text-xs opacity-75">18/01</p>
                </div>

                <!-- Cartão 7 -->
                <div class="bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-lg p-2 text-white w-32">
                    <div class="flex justify-between items-start mb-1">
                        <div class="w-6 h-4 bg-gray-300 rounded"></div>
                        <span class="text-xs font-medium">INTER</span>
                    </div>
                    <p class="text-xs opacity-90">R$ 4.000</p>
                    <p class="text-xs font-bold">R$ 3.500</p>
        ...
        <div class="grid grid-cols-7 gap-3">
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700">
                ...
                <div class="p-4 h-64 overflow-y-auto">
                    <div class="flex justify-between items-center text-xs py-0.5 border-b border-gray-600">
                        <span class="text-red-400">Mercado</span>
                        <div class="flex items-center gap-2">
                            <span class="text-red-400">R$ 450</span>
                            <div class="w-4 h-3 bg-blue-600 rounded text-xs"></div>
                        </div>
                    </div>
                    <div class="flex justify-between items-center text-xs py-0.5 border-b border-gray-600">
                        <span class="text-green-400">Salário</span>
                        <span class="text-green-400">R$ 5.000</span>
                    </div>
                    <div class="flex justify-between items-center text-xs py-0.5 border-b border-gray-600">
                        <span class="text-red-400">Aluguel</span>
                        <span class="text-red-400">R$ 1.200</span>
                    </div>
                    <div class="flex justify-between items-center text-xs py-0.5 border-b border-gray-600">
                        <span class="text-red-400">Gasolina</span>
                        <div class="flex items-center gap-2">
                            <span class="text-red-400">R$ 180</span>
                            <div class="w-4 h-3 bg-red-600 rounded text-xs"></div>
                        </div>
                    </div>
                    <div class="flex justify-between items-center text-xs py-0.5 border-b border-gray-600">
                        <span class="text-red-400">Farmácia</span>
                        <div class="flex items-center gap-2">
                            <span class="text-red-400">R$ 85</span>
                            <div class="w-4 h-3 bg-purple-600 rounded text-xs"></div>
                        </div>
                    </div>
                    <div class="flex justify-between items-center text-xs py-0.5">
                        <span class="text-green-400">Freelance</span>
                        <span class="text-green-400">R$ 800</span>
                    </div>
                </div>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700">
                ...
                <div class="p-4 h-64 overflow-y-auto">
                    ...
                    <div class="flex justify-between items-center text-xs py-0.5 border-b border-gray-600">
                        <span class="text-red-400">Internet</span>
                        <span class="text-red-400">R$ 120</span>
                    </div>
                    <div class="flex justify-between items-center text-xs py-0.5 border-b border-gray-600">
                        <span class="text-red-400">Restaurante</span>
                        <div class="flex items-center gap-2">
                            <span class="text-red-400">R$ 95</span>
                            <div class="w-4 h-3 bg-pink-600 rounded text-xs"></div>
                        </div>
                    </div>
                    <div class="flex justify-between items-center text-xs py-0.5">
                        <span class="text-red-400">Academia</span>
                        <span class="text-red-400">R$ 80</span>
                    </div>
                </div>
                <div class="p-4 border-t border-gray-700 text-sm">
                    <div class="flex justify-between text-red-400">
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700">
                ...
                <div class="p-4 h-64 overflow-y-auto">
                    <div class="flex justify-between items-center text-xs py-0.5 border-b border-gray-600">
                        ...
                        <span class="text-purple-400">R$ 120</span>
                    </div>
                    <div class="flex justify-between items-center text-xs py-0.5 border-b border-gray-600">
                        <span class="text-purple-400">Irmão - Gasolina</span>
                        <span class="text-purple-400">R$ 80</span>
                    </div>
                    <div class="flex justify-between items-center text-xs py-0.5">
                        <span class="text-purple-400">Pai - Mercado</span>
                        <span class="text-purple-400">R$ 200</span>
                    </div>
                </div>
                <div class="p-4 border-t border-gray-700 text-sm">
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700">
                ...
                <div class="p-4 h-64 overflow-y-auto">
                    <div class="flex justify-between items-center text-xs py-0.5 border-b border-gray-600">
                        ...
                        <span class="text-purple-400">R$ 150</span>
                    </div>
                    <div class="flex justify-between items-center text-xs py-0.5">
                        <span class="text-purple-400">Sogra - Compras</span>
                        <span class="text-purple-400">R$ 90</span>
                    </div>
                </div>
                <div class="p-4 border-t border-gray-700 text-sm">
                    <div class="flex justify-between text-purple-400">
        ...
        <div class="bg-gray-800 rounded-lg p-6 w-full max-w-lg mx-4 border border-gray-700">
            ...
            <div class="space-y-3 max-h-96 overflow-y-auto">
                ...
                <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-yellow-500 rounded flex items-center justify-center text-black font-bold text-xs">BB</div>
                        <span class="text-white">Banco do Brasil</span>
                    </div>
                    <input type="number" step="0.01" class="w-24 px-2 py-1 bg-gray-600 border border-gray-500 rounded text-white text-sm" placeholder="0,00">
                </div>

                <!-- Itaú -->
                <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-orange-500 rounded flex items-center justify-center text-white font-bold text-xs">IT</div>
                ...
                <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-red-600 rounded flex items-center justify-center text-white font-bold text-xs">BR</div>
                ...
                <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-red-500 rounded flex items-center justify-center text-white font-bold text-xs">ST</div>
                ...
                <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-purple-600 rounded flex items-center justify-center text-white font-bold text-xs">NU</div>
                ...
                <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-orange-600 rounded flex items-center justify-center text-white font-bold text-xs">IN</div>
